...
/obj/item/device/pda
	...
	w_class = 2.0
	flags = FPRINT | TABLEPASS | ONBELT | WEAR_ID

	var/owner = null
	var/job = ""
	var/default_cartridge = 0 // Access level defined by cartridge
	var/obj/item/weapon/cartridge/cartridge = null //current cartridge
	var/obj/item/weapon/card/id/stored_id = null //Stored ID card
	...
	if (!src.owner)
		...
		switch (src.mode)
			if (0)
				...
				dat += "Owner: [src.owner]"
				dat += "ID: <a href='byond://?src=\ref[src];id=1'>[stored_id? "[stored_id.registered],[stored_id.assignment]":"<u>---------</u>"]</a>"
				dat += "<br><br>"
