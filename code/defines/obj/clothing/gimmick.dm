...
/obj/item/clothing/under/mining/miner
	name = "Miner's uniform"
	desc = "The uniform that is worn by miners."
	icon_state = "brown"
	color = "brown"

/obj/item/clothing/under/mining/hauler
	name = "Hauler's Uniform"
	desc = "The uniform that is worn by haulers."
	icon_state = "yellowgreen"
	color = "yellowgreen"

/obj/item/clothing/under/mining/foreman
	name = "Foreman's Uniform"
	desc = "The uniform that is worn by the foreman."
	icon_state = "darkblue"
	color = "darkblue"
