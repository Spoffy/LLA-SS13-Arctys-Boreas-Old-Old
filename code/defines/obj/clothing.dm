...
/obj/item/clothing/suit/mars
	name = "mars suit"
	desc = "A suit that protects against low pressure environments on mars."
	icon_state = "space"
	gas_transfer_coefficient = 0.01
	item_state = "s_suit"
	flags = FPRINT | TABLEPASS | SUITMARS
	body_parts_covered = UPPER_TORSO|LOWER_TORSO|LEGS|FEET|ARMS|HANDS
	permeability_coefficient = 0.02
	protective_temperature = 1000
	heat_transfer_coefficient = 0.02
...
/obj/item/clothing/under/rank/tourist
	desc = "A hawaiian shirt and shorts. Must be a tourist."
