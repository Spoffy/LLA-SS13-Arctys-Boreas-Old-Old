...
/obj/vehicle/meteorhit(var/obj/O as obj)
...
/obj/vehicle/relaymove(mob/user as mob, direction)
	if (user.stat)
		return
	...
	*/
		...
		while(t1 > 0)
			...
			t1--
/*
/obj/vehicle/verb/stop()
	set src in oview(1)
	set src = usr.loc
	src.speed = 0
*/
/obj/vehicle/verb/eject()
	set src = usr.loc
...
/obj/vehicle/verb/unload(var/atom/movable/A in src)
	set src in oview(1)
