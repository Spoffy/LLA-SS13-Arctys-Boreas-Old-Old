...
//	add_construction_kit("Test",/obj/item/weapon/crowbar,3)
	...
	add_construction_kit("Chemistry Vender",/obj/machinery/vending/chemi,15)
	add_construction_kit("Mining Vender",/obj/machinery/vending/mining,15)
	...
	add_construction_kit("Medical Vender",/obj/machinery/vending/medical,15)
